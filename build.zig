...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("zig_files_hash", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "zig_files_hash" is the name you will use in your source code to
                // import this module (e.g. `@import("zig_files_hash")`). The name is
